		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ngscprojecttest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ngscprojecttest-display": {
								"semanticObject": "ngscprojecttest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ngsc.projecttest",
									"url": sap.ui.require.toUrl("ngsc/projecttest")
								}
							}
						}
					}
